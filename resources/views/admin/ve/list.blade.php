                                ...
                                <table class="table align-items-center mb-0 ">
                                    ...
                                    <tr>
                                        <td class="align-middle text-center">
                                            ...
                                            <h6 class="mb-0 text-sm " style="width:150px; overflow: hidden; text-overflow: ellipsis; display: -webkit-box; -webkit-line-clamp: 1; -webkit-box-orient: vertical">{!! $value['schedule']['movie']['ten_phim'] !!}</h6>
                                            @endisset
                                        </td>
                                        <td class="align-middle text-center">
                                            @isset($value['schedule'])
                                            <h6 class="mb-0 text-sm ">{!! $value['schedule']['room']['roomType']['ten_loai_phong'] !!}</h6>
                                            @endisset
                                        </td>
                                        <td class="align-middle text-center">
                                            @isset($value['schedule'])
                                            <h6 class="mb-0 text-sm ">{!! $value['schedule']['room']['ten_phong'] !!}</h6>
                                            @endisset
                                        </td>
                                        <td class="align-middle text-center">
                                            ...
                                            @if(isset($value->ticketCombos) || isset($value->ticketFoods))
                                                <span class="text-secondary font-weight-bold" >
                                                    @foreach($value['ticketCombos'] as $combo)
                                                            • {{ $combo->ten_combo.' x '. $combo->so_luong }} <br>
                                                    @endforeach
                                                    {{-- @foreach($value['ticketFoods'] as $food)
                                                            • {{ $food->ten_food.' x '. $food->so_luong }} <br>
                                                    @endforeach --}}
                                                </span>
                                        ...
                                        <td class="align-middle text-center">
                                            @isset($value['schedule'])
                                            <span class="text-secondary font-weight-bold">{!! date("d-m-Y", strtotime($value['schedule']['ngay'])) !!}</span>
                                            @endisset
                                        </td>
                                        {{-- <td class="align-middle text-center">
