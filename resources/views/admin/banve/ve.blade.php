        ...
        <div class="row">
                ...
                <div id="ticket_info" class="card mb-3 bg-dark text-light px-0 sticky-top">
                    <div class="row">
                        <div class="col-12 col-md-3 col-lg-12 d-flex justify-content-center">
                            ...
                            <img style="max-height: 361px; max-width: 241px" src="{!! $movie['image'] !!}" alt="user1">
                            @else
                            <img style="max-height: 361px; max-width: 241px" src="{!! $movie['image'] !!}" alt="user1">
                            @endif
            ...
            <div class="col-12 col-lg-9">
                ...
                <div style="" id="mainTicket">
                                ...
                                <div class="col-12">
                                    <div class="card mb-4">
                                        ...
                                        <div class="card-body px-0 pt-0 pb-2">
                                            ...
                                            <div style="" class="d-block overflow-x-auto text-center">
                                                <div class="d-inline-block flex-nowrap mt-2 my-auto mb-4 text-center justify-content-center">
                                                    {{--Màn hình--}}
                                                    @lang('lang.screen')
                                                    <div class="row bg-dark mx-auto" style="height: 2px; max-width: 500px"></div>
                                                    ...
                                                    @foreach($room->rows as $row)
                                                        <div class="row d-flex flex-nowrap justify-content-center" id="Row_{{ $row->row }}"
                                                              style="@if($room->ghes->count() > 300)width: 900px;@endif margin: 2px" >
                                                ...
                                                <div class="card-body input_combo_block">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="number" class="form-control input_combo" name="combo[{{$combo->id_combo}}]" value="0"
                                                               ...
                                                               style="max-width: 50px; max-height:40px " aria-label="">
                    ...
                    {{-- Thanh toán --}}
                    <div style="margin-top:200px" id="Payment" class="mt-20 collapse" data-bs-parent="#mainTicket">
                            ...
                            <div class="bg-dark-subtle p-5">
                                <div class="row row-cols-1">
                                    <div class="form-check pe-4" id="bankCode">
                                        <div class="input-group">
                                            <input size="80%" style="height: 80%" type="text" class="form-control border-dark" id="discount" aria-label="" placeholder="Nhập mã khuyến mãi...">
                                            <button id="btn_apply_discount" class="btn btn-danger">@lang('lang.apply')</button>
                                        </div>
            ...
            <div id="Payment" class="mt-1 collapse" data-bs-parent="#mainTicket">
                <form id="paymentForm2" action="admin/banve/createPayment" method="post">
                    @csrf
                    <div class="bg-dark-subtle p-5">
...
<script>
   // $(document).ready(() => {
            ...
            let $luu_giamgia=0;
            let $tong_goc=0;
            var processingDiscount = false;
            let $lastDiscountPercent = 0;
        ...
        // Các cài đặt khác ở đây...
            ...
            console.log("VE HIENJ TAI LA"+$ticket_id); // In giá trị của biến $ticket_seats vào console
            ...
            $('#tongtienveid').val($sum.toLocaleString('vi-VN'));
            ...
            paymentNext = () => {
                ...
                $('#tongve').val($sum.toLocaleString('vi-VN'));
            ...
            var processingDiscount = false; // Biến để kiểm tra xem việc xử lý giảm giá đang được thực hiện hay không
var discountApplied = false; // Biến để kiểm tra xem thẻ giảm giá đã được áp dụng hay chưa
...
$('#btn_apply_discount').click(function (){
    if ($discountApplied) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data['success']) {
                            ...
                            $('#disList').append($html);
                            $lastDiscountPercent = data.percent;
                            $sum_discount = ($sum*(100-data.percent))/100;
                            $b_discount=(100-data.percent)/100;
                            $sum=$sum_discount;
            ...
            $('#disList').on('click', '#disCancelBtn', (e) => {
                $sum = ($sum * 100) / (100 - $lastDiscountPercent);
                $('#disCode').text('');
                $('#disPercent').text('');
