<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 z-index-1" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse w-auto h-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            {{-- @can('theater') --}}
            <li class="nav-item">
                <a class="nav-link @yield('active')" href="./admin/rap">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            ...
            {{-- @can('price') --}}
            <li class="nav-item">
                <a class="nav-link @yield('active')" href="./admin/gia_ve">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            ...
            {{-- @can('schedule_movie') --}}
            <li class="nav-item">
                <a class="nav-link @yield('active')" href="./admin/lichtrinh">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link @yield('active')" href="./admin/tintuc">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            ...
            {{-- @can('ticket') --}}
            <li class="nav-item">
                <a class="nav-link @yield('active')" href="./admin/ve">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            ...
            {{-- @can('banners') --}}
            <li class="nav-item">
                <a class="nav-link @yield('active')" href="./admin/banner">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            ...
            {{-- @can('director') --}}
            <li class="nav-item">
                <a class="nav-link @yield('active')" href="./admin/daodien">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            ...
            {{-- @can('cast') --}}
            <li class="nav-item">
                <a class="nav-link @yield('active')" href="./admin/dienvien">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            ...
            {{-- @can('buyTicket') --}}
            <li class="nav-item">
                <a class="nav-link @yield('active')" href="./admin/banve">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
