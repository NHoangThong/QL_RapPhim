                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body px-0 pt-0 pb-2 mt-5">
                        <div class="table-responsive ">
                            <form action="admin/gia_ve/edit" method="post">
                                @csrf
                                <table class="table table-bordered align-items-center text-center">
                                    ...
                                    @foreach($roomTypes as $roomType)
                                        <tr>
                                            ...
                                            <td colspan="5">
                                                <div class="input-group">
                                                    <input type="number" class="form-control" name="{{ $roomType->id_loai_phong }}"
                                                           value="{{ $roomType->phu_phi }}"
                                                           aria-label="">
                                                    <span class="input-group-text">đ</span>
                                                </div>
                                            </td>
                                    ...
                                    @foreach($seatTypes as $seatType)
                                        <tr>
                                            <td class="text-end">
                                                Ghế {{ $seatType->ten_loai_ghe }}
                                            </td>
                                            <td colspan="5">
                                                <div class="input-group">
                                                    <input type="number" class="form-control" name="{{ $seatType->id_loai_ghe }}"
                                                           value="{{ $seatType->phu_phi }}"
                                                           aria-label="">
                                                    <span class="input-group-text">đ</span>
                                                </div>
                                            </td>
